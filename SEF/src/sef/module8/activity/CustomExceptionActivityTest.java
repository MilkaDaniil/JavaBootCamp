...
public class CustomExceptionActivityTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            customExceptionActivityTest.validateUser("Daniils");
            customExceptionActivityTest.validateUser("Igors");
            customExceptionActivityTest.validateUser("Anastacia");
            customExceptionActivityTest.validateUser("Sofija");
    ...
    void validateUser(String name) throws CustomExceptionActivity {
        ...
        //array of names
        String[] validUsers = {"Daniils", "Igors", "Anastacia", "Sofia"};
